...
colnames(mean_FWB_by_fpl.list2) <- c("Mean FWB Score")

mean_FWB_by_fpl.list2$meanfwB <- c("200%+ FPL", "100% - 199% FPL", ">100% FPL", "Overall Mean")

mean_FWB_by_fpl2 <- select(mean_FWB_by_fpl.list2, meanfwB:"Mean FWB Score")
...
fplLevelsFWB <- ggplot(mean_FWB_by_fpl2) +
  geom_col(aes(
    x=factor(
      meanfwB, level=c("Overall Mean", ">100% FPL", "100% - 199% FPL", "200%+ FPL")), y="Mean FWB Score", group = 1, color = meanfwB, fill = meanfwB))
print(fplLevelsFWB)
...
colnames(mean_FS_by_fpl.list2) <- c("Mean FS Score")

mean_FS_by_fpl.list2$meanfS <- c("200%+ FPL", "100% - 199% FPL", ">100% FPL", "Overall Mean")

mean_FS_by_fpl2 <- select(mean_FS_by_fpl.list2, meanfS:"Mean FS Score")
...
fplLevelsFS <- ggplot(mean_FS_by_fpl2) +
  geom_col(aes(
    x=factor(
      meanfS, level=c("Overall Mean", ">100% FPL", "100% - 199% FPL", "200%+ FPL")), y="Mean FS Score", group = 1, color = meanfS, fill = meanfS))
print(fplLevelsFS)
...
colnames(mean_LM_by_fpl.list2) <- c("Mean LM Score")

mean_LM_by_fpl.list2$meanLM <- c("200%+ FPL", "100% - 199% FPL", ">100% FPL", "Overall Mean")

mean_LM_by_fpl2 <- select(mean_LM_by_fpl.list2, meanLM:"Mean LM Score")
...
fplLevelsLM <- ggplot(mean_LM_by_fpl2) +
  geom_col(aes(
    x=factor(
      meanLM, level=c("Overall Mean", ">100% FPL", "100% - 199% FPL", "200%+ FPL")), y="Mean LM Score", group = 1, color = meanLM, fill = meanLM))
print(fplLevelsLM)
...
colnames(mean_KH_by_fpl.list2) <- c("Mean KH Score")

mean_KH_by_fpl.list2$meanKH <- c("200%+ FPL", "100% - 199% FPL", ">100% FPL", "Overall Mean")

mean_KH_by_fpl2 <- select(mean_KH_by_fpl.list2, meanKH:"Mean KH Score")
...
fplLevelsKH <- ggplot(mean_KH_by_fpl2) +
  geom_col(aes(
    x=factor(
      meanKH, level=c("Overall Mean", ">100% FPL", "100% - 199% FPL", "200%+ FPL")), y="Mean KH Score", group = 1, color = meanKH, fill = meanKH))
print(fplLevelsKH)
