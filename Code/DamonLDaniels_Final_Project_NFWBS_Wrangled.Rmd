...
NFWBS.processed <- read.csv("/home/guest/EDA_Spring2024/DamonLDanielsCourseProject/Data/Processed_Data/NFWBS_PUF_2016_data.PROCESSED.csv")

```

``` {r Read-In of NWBS Dataset Codebook Designations}

df <- NFWBS.processed

# From "NFWBS_PUF_2016_read_in_R.R" file:

# The plyr library will be used to help us remap values
library(plyr)

# Codes on lines 57 through 1448 will change values and descriptors to match the CFPB NFWBS codebook. 
...
# Relevant NFWBS Dataset Columns for Wrangling:
  # Column  1     (PUF ID - Public Use File ID)
  # Column  2     (sample)
  # Column  3     (fpl - Federal Poverty Level)
...
NFWBS.wrangled <- select(NFWBS, PUF_ID:SWB_3, FWBscore, FSscore, LMscore, KHscore)


```

``` {r Write New Processed File for NFWBS.wrangled}

write.csv(NFWBS.wrangled, row.names = FALSE,
          file = "./Data/Processed_Data/NFWBS_wrangled_PROCESSED.csv")
