...
# Relevant Columns for Wrangling:
  ...
  # Columns 8-17  (FWBscore - Financial Well-Being Scale Scores; 9 separate questions)
  # Column  18    (FSscore - Financial Skill Scale Scores)
  # Columns 19-25 (FS1 - Financial Skill Scale Scores; 7 separate questions)
  # Columns 26-28 (FS2 - Financial Skill Scale Scores; 3 separate questions)
  # Column  51    (LMscore - Lusardi & Mitchell Financial Knowledge Scale Score) 
  # Columns 52-54 (LMscore - Lusardi & Mitchell Financial Knowledge Scale Score; 3 separate questions)
   # Columns 55-57 (LMscore - Lusardi & Mitchell Financial Knowledge Scale Score, Correct vs Incorrect; 3 separate questions [Correct = "Yes" or Incorrect = "No" answers pertaining to columns 59-67])
  # Column  58    (KHscore - Knoll & Houts Financial Knowledge Scale Score) 
  # Columns 59-67 (KHscore - Knoll & Houts Financial Knowledge Scale Score; 9 separate questions)
  # Columns 68-76 (KHscore - Knoll & Houts Financial Knowledge Scale Score, Correct vs Incorrect; 9 separate questions [Correct = "Yes" or Incorrect = "No" answers pertaining to columns 59-67])

# Create New Dataframe

df2 <- select(df, PUF_ID:FS2_3, LMscore:KH9correct)
dim(df2)
...
# What associations can be drawn between an (1) an individual’s or household’s federal poverty level (FPL) and (2) measures of financial knowledge that are (A) self-reported versus (B) accurate or inaccurate according to 2 separate financial literacy scales?
...
# Summary Data by Federal Poverty Level (FPL)
