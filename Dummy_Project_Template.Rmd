...
df2 <- select(df, PUF_ID:SWB_3, FWBscore, FSscore, KHscore)
dim(df2)
...
mean_SWB_by_fpl2$meanSWB <- c("Total Mean SWB", "Mean SWB, >100% FPL", "Mean SWB, 100% - 199% FPL", "Mean SWB, 200%+ FPL")
...
fplLevels <- ggplot(mean_SWB_by_fpl2) +
  geom_col(aes(
    x=factor(
      meanSWB, level=c("Total Mean SWB", "Mean SWB, >100% FPL", "Mean SWB, 100% - 199% FPL", "Mean SWB, 200%+ FPL")), y=SWB_1, group = 1, color = meanSWB, fill = meanSWB))
print(fplLevels)
...
fplLevels2 <- ggplot(mean_SWB_by_fpl2) +
  ...
  geom_col(aes(
    x=factor(
      meanSWB, level=c("Total Mean SWB", "Mean SWB, >100% FPL", "Mean SWB, 100% - 199% FPL", "Mean SWB, 200%+ FPL")), y=SWB_2, group = 1, color = meanSWB, fill = meanSWB))
print(fplLevels2)
...
fplLevels3 <- ggplot(mean_SWB_by_fpl2) +
  ...
  geom_col(aes(
    x=factor(
      meanSWB, level=c("Total Mean SWB", "Mean SWB, >100% FPL", "Mean SWB, 100% - 199% FPL", "Mean SWB, 200%+ FPL")), y=SWB_3, group = 1, color = meanSWB, fill = meanSWB))
print(fplLevels3)
